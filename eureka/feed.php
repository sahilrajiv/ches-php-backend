...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	$q1 = mysqli_query($dbc,"SELECT * FROM eureka2020_posts ORDER BY time DESC");
                ...
                <div class="schedule-tab">
                    ...
                    <ul class="nav nav-tabs wow fadeInUp" data-wow-delay="300ms" id="conferScheduleTab" role="tablist">
                        ...
                        <li class="nav-item">
                            ...
                            <a class="nav-link" id="monday-tab" >
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <? while($data1 = mysqli_fetch_row($q1)){
									...
									$q2 = mysqli_query($dbc,"SELECT * FROM eureka2020 WHERE team_id='$data1[1]'");
                        ...
                        <div class="single-schedule-area single-page d-flex flex-wrap justify-content-between align-items-center wow fadeInUp" data-wow-delay="300ms">
                            ...
                            <div class="single-schedule-info" style="word-break: break-word;">


                                <h7><span>
                                        <? echo $data2[1]; ?></span></h6>
                                    <h6 style="color:blue;">
                                        <? echo $data2[4]; ?>
                                    </h6>
                                    ...
                                    <p style="color:green;">
                                       <?$date = new DateTime($data1[3], new DateTimeZone('UTC'));
